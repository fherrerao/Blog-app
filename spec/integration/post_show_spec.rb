...
RSpec.describe 'User Show Page', type: :feature do
  describe 'User Info' do
    before :all do
      Comment.destroy_all
      User.destroy_all
      user1 = User.create(id: 1, name: 'User-1', photo: 'https://www.test.com/user-image-1.png', bio: 'some1',
                          email: 'anotheruser1@example.com', password: '123456',
                          confirmed_at: DateTime.now, posts_counter: 0)
      user2 = User.create(id: 2, name: 'User-2', photo: 'https://www.test.com/user-image-2.png', bio: 'some1',
                          email: 'anotheruser2@example.com', password: '123456',
                          confirmed_at: DateTime.now, posts_counter: 0)
